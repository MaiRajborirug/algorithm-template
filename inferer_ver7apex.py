...
class SynthradAlgorithm:
    ...
    def process_cases(self, data_path, exp_name, anatomical_region="HN"):
        ...
        for case_dir in tqdm(case_dirs):
            ...
            if case_dir not in ['1HNC111', '1HNA132']:
                continue
...
def main():
    ...
    config_path = "/home/rajbori.p/github/proj_synthrad/MOTFM3D/configs/test_apex1.yaml"
    ...
    checkpoint_dir = "/home/rajbori.p/github/proj_synthrad/MOTFM3D/checkpoints/apex-dist3-llf-HN/epoch_700"
    ...
    data_path = "/home/rajbori.p/dataset/proj_synthrad/training/synthRAD2025_Train_ABCD/Task1/HN"
    
    # exp_name = "/media/prajbori/sda/private/github/proj_synthrad/algorithm-template/output_llfHN1"
    exp_name = "/home/rajbori.p/github/home/rajbori.p/github/proj_synthrad/algorithm-template/output_llfHN1"
